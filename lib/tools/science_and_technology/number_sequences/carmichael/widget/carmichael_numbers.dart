...
class NumberSequenceCarmichaelNumbersFromTo extends NumberSequenceFromTo {
  const NumberSequenceCarmichaelNumbersFromTo({super.key}) : super(mode: NumberSequencesMode.CARMICHAEL, maxIndex: 1713045574801);
}
